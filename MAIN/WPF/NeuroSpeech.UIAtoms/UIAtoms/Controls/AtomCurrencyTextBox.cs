...
namespace NeuroSpeech.UIAtoms.Controls
{
    ...
    public class AtomCurrencyTextBox : AtomRangeBase<decimal, decimal>
    {
        ...
        static AtomCurrencyTextBox()
        {
            ...
            DefaultStyleKeyProperty.OverrideMetadata(typeof(AtomCurrencyTextBox),
        ...
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(AtomCurrencyTextBox), new PropertyMetadata("$ {0:#,###,##0.00}", OnStringFormatChangedCallback));

#else
        public static readonly DependencyProperty StringFormatProperty =
            DependencyProperty.Register("StringFormat", typeof(string), typeof(AtomCurrencyTextBox), new UIPropertyMetadata("$ {0:#,###,##0.00}", OnStringFormatChangedCallback));
#endif
        private static void OnStringFormatChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            AtomCurrencyTextBox obj = d as AtomCurrencyTextBox;
            if (obj != null)
            {
        ...
        ///<summary>
        /// Dependency Property CalculatorVisibility
        ///</summary>
        #region Dependency Property CalculatorVisibility
        [AtomDesign(
          Category = "Atoms",
          Bindable = true,
          BrowseMode = AtomPropertyBrowseMode.Default
        ...
        {
            get { return (Visibility)GetValue(CalculatorVisibilityProperty); }
            set { SetValue(CalculatorVisibilityProperty, value); }
        }

        ///<summary>
        /// Using a DependencyProperty as the backing store for CalculatorVisibility.  This enables animation, styling, binding, etc...
        ///</summary>
#if SILVERLIGHT
        public static readonly DependencyProperty CalculatorVisibilityProperty = 
            DependencyProperty.Register("CalculatorVisibility", typeof(Visibility), typeof(AtomCurrencyTextBox), new PropertyMetadata(Visibility.Visible));

        private static void OnCalculatorVisibilityChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e){
            AtomCurrencyTextBox obj = d as AtomCurrencyTextBox;
        }
    
#else
        public static readonly DependencyProperty CalculatorVisibilityProperty =
            DependencyProperty.Register("CalculatorVisibility", typeof(Visibility), typeof(AtomCurrencyTextBox), new FrameworkPropertyMetadata(Visibility.Visible));
#endif
